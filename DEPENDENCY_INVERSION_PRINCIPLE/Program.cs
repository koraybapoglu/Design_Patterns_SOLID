...
namespace Loose_Coupling_Principles
{
	internal class Program
	{
		static void Main(string[] args)
		{
			...
			{
				mailSender.SendMail(new Mail(), MailAdresi, mesaj, mymail, mymailsifre); //BURADA MAİLSENDER KULLANARAK ARTIK MAİLSENDER PARAMETRESİNİN İSTEDİĞİ FORMAT HANGİSİ İSE ONU EKLİYORUZ.
			}
			else if (domain.Contains("yandex"))
			{
				mailSender.SendMail(new Yandex(), MailAdresi, mesaj, mymail, mymailsifre); //BURADA MAİLSENDER KULLANARAK ARTIK MAİLSENDER PARAMETRESİNİN İSTEDİĞİ FORMAT HANGİSİ İSE ONU EKLİYORUZ.

			}
			else if (domain.Contains("gmail"))
			{
				mailSender.SendMail(new Gmail(), MailAdresi, mesaj, mymail, mymailsifre); //BURADA MAİLSENDER KULLANARAK ARTIK MAİLSENDER PARAMETRESİNİN İSTEDİĞİ FORMAT HANGİSİ İSE ONU EKLİYORUZ.
			}
			else
			{
